...
const myEmployeesAddresses = _.map(myEmployees, val => val.address); // use pluck to get addresses here.

// Now we want to use pluck to get an array of ages of the employees.

const myEmployeesAges = _.map(myEmployees, val => val.age); // use pluck to get ages here.
...
const purchasesByMonth = _.groupBy(purchases, obj => obj.month); // Use groupBy to group the purchases by the month that they were made.
